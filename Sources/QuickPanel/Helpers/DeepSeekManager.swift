...
final class DeepSeekManager: ObservableObject {
    ...
    @Published var dailyCost: String = "0.00"
    @Published var monthlyCost: String = "--"
    ...
    func refresh() {
        ...
        guard let url = URL(string: "\(baseURL)/user/balance") else {
            isLoading = false; errorMessage = "URL 无效"; return
        }
